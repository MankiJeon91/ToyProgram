...
public class MemberUpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			 ...
			 * response.getWriter(); out.println("<html><head><title>회원정보</title></head>");
			 * out.println("<body><h1>회원정보</h1>");
			 * out.println("<form action='update' method='post'>");
			 * out.println("번호 : <input type='text' name='no' value='"+request.getParameter(
			 * "no")+"' readonly><br>");
			 * out.println("이름 : *<input type='text' name='name' value='"+rs.getString(
			 * "MNAME")+"'><br>");
			 * out.println("이메일 : <input type='text' name='email' value='"+rs.getString(
			 * "EMAIL")+"' ><br>"); out.println("가입일 : "+rs.getDate("CRE_DATE")+"<br>");
			 * out.println("<input type='submit' value='저장'>"); out.
			 * println("<input type='button' value='삭제' onclick='location.href=\"delete?no="
			 * + request.getParameter("no")+"\"'>"); out.
